...
#comments
comment1 = CardComment.create!(content: "my first comment ever, yay", card_id: card1.id)
comment2 = CardComment.create!(content: "I'm blue Da ba dee da ba di", card_id: card1.id)
comment3 = CardComment.create!(content: "Eh, its just a fleshwound.", card_id: card2.id)
comment4 = CardComment.create!(content: "A jak pan jezus powiedział?", card_id: card2.id)
comment5 = CardComment.create!(content: "Tak jak pan jezus powiedział", card_id: card3.id)
comment6 = CardComment.create!(content: "No jak mi dają to jem", card_id: card3.id)
comment7 = CardComment.create!(content: "Ravioli ravioli give me the death I deservioli", card_id: card4.id)
comment8 = CardComment.create!(content: "How do you do fellow kids?", card_id: card4.id)