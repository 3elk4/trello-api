...
user = User.create!(username: "geralt", password: "Zar@za!2137", email: "g3r4lt_uwu@wyzima.pl")
...
list_board1 = List.create!(name: "Test list 1", board_id: board1.id, position: 0)
list_board2 = List.create!(name: "test list 2", board_id: board2.id, position: 0)

archivedboard_list1 = List.create!(name: "archived1", board_id: archived1.id, position: 0)
archivedboard_list2 = List.create!(name: "archived2", board_id: archived2.id, position: 0)
